...
### Ecosystem sub-types
We can show the resulting scaled values as Violin plots for each indicator and main ecosystem type 
...
p_L1_tre <- res.natopen.GRUK %>%
  ...
  geom_point() +
  labs(y = "Light1 (Light index towards lower limit value)", x = "Tree cover (%)")
...
p_L1_tre <- p_L1_tre +
  geom_line(data=data.frame(x=0:100,y=expit(pred$mu)), aes(x,y),col="firebrick",size=2) +
...
p_L2_slit <- res.natopen.GRUK %>%
  ...
  geom_point() +
  labs(y = "Light2 (Light index towards upper limit value)", x = "Erosion/Disturbance cover (%)")
...
p_N2_frem <- res.natopen.GRUK %>%
  ...
  geom_point() +
  labs(y = "Nitrogen2 (Nitrogen index towards upper limit value)", x = "Alien plant species cover (%)")
...
p_Sd1_tre <- res.natopen.GRUK %>%
  ...
  ggplot(aes(x=Dekning_tresjikt, y=scaled_value)) +
  geom_point() +
  labs(y = "Soil_disturbance1 (Soil disturbance index towards lower limit value)", x = "Tree cover (%)")
...
p_Sd2_prob <- res.natopen.GRUK %>%
  ...
  geom_point() +
  labs(y = "Soil_disturbance2 (Soil disturbance index towards upper limit value)", x = "Problem species cover (%)")
...
p_CC2_prob <- res.natopen.GRUK %>%
  ...
  ggplot(aes(x=Dekning_problemarter, y=scaled_value)) +
  geom_point() +
  labs(y = "CSR-C2 (Grime's C index towards upper limit value)", x = "Problem species cover (%)")
...
p_CC2_frem <- res.natopen.GRUK %>%
  ...
  ggplot(aes(x=Totaldekning_fremmedearter, y=scaled_value)) +
  geom_point() +
  labs(y = "CSR-C2 (Grime's C index towards upper limit value)", x = "Alien species cover (%)")
...
ggarrange(p_L1_tre, p_L2_slit, p_N2_frem, p_Sd1_tre, p_Sd2_prob, p_CC2_prob, p_CC2_frem + rremove("x.text"), 
...
tm_shape(regnor, bbox=boks) +
  ...
  tm_layout(main.title = "Tilstand, GRUK lokaliteter",legend.position = c("right", "bottom"), main.title.size=1.2)
...
tm_shape(regnor, bbox=boks.Oslo) +
  ...
  tm_shape(GRUK.polygoner2) +
  tm_dots('Tilstand',palette=tmaptools::get_brewer_pal("RdYlGn", 3, plot = FALSE), scale=4, legend.show = TRUE) +  
  tm_layout(main.title = "Tilstand, GRUK lokaliteter Indre Oslofjord",legend.position = c("right", "bottom"), main.title.size=1.2)
...
tm_shape(regnor, bbox=boks.mid) +
  ...
  tm_shape(GRUK.polygoner2) +
  tm_dots('Tilstand',palette=tmaptools::get_brewer_pal("RdYlGn", 3, plot = FALSE), scale=4, legend.show = TRUE) +  
  tm_layout(main.title = "Tilstand, GRUK lokaliteter Midtre Oslofjord",legend.position = c("right", "bottom"), main.title.size=1.2)
...
tm_shape(regnor, bbox=boks.south) +
  ...
  tm_shape(GRUK.polygoner2) +
  tm_dots('Tilstand',palette=tmaptools::get_brewer_pal("RdYlGn", 3, plot = FALSE), scale=4, legend.show = TRUE) +  
  tm_layout(main.title = "Tilstand, GRUK lokaliteter Ytre Oslofjord",legend.position = c("right", "bottom"), main.title.size=1.2)
